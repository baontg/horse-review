...
import { _decorator, Component, Node, Input, EventKeyboard, KeyCode, input, Vec3, Quat, Camera, director, EventMouse, game } from 'cc';
...
export class ToolCameraController extends Component {
    ...
    start () {
        ...
        input.on(Input.EventType.MOUSE_WHEEL, this.OnMouseEvent, this);
        input.on(Input.EventType.MOUSE_DOWN, this.OnMouseEvent, this);
        input.on(Input.EventType.MOUSE_UP, this.OnMouseEvent, this);
        input.on(Input.EventType.MOUSE_MOVE, this.OnMouseEvent, this);
    ...
    {
        // if(event.getLocationX() > view.getViewportRect().width - 250)
        //     return;
        // if(event.getButton() != -1)
        //     console.log("OnMouseWheel getLocationX " + event.getLocationX() + " movementX " + + event.movementX + " getButton " + event.getButton());
    ...
    onDestroy()
    {
        ...
        input.off(Input.EventType.MOUSE_WHEEL, this.OnMouseEvent, this);
        input.off(Input.EventType.MOUSE_DOWN, this.OnMouseEvent, this);
        input.off(Input.EventType.MOUSE_UP, this.OnMouseEvent, this);
        input.off(Input.EventType.MOUSE_MOVE, this.OnMouseEvent, this);
    }
}
